...
const playSpinSound = () => {
    try {
        ...
        // Create a spinning sound with rising frequency
...
export function SpinWheel({
    ...
    const handleSpin = async () => {
        ...
        try {
            ...
            const distanceToStop = (stopAngle - currentMod + 360) % 360;
    ...
    return (
        <div className="flex flex-col items-center gap-10 relative z-10 w-full py-4">
            ...
            <div className="text-center space-y-2">
                <h2 className="text-4xl md:text-5xl font-black text-white italic tracking-tight drop-shadow-2xl pr-2">CKB <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 via-yellow-400 via-green-400 via-blue-400 to-purple-400">SPIN WHEEL</span></h2>
                <p className="text-gray-400">Spin the wheel and test your fortune! Win up to 10,000 CKB!</p>
            </div>
                    ...
                    <div className="relative">
                        <div
                            ...
                            style={{
                                ...
                                transform: `rotate(${isSpinning ? Math.sin(Date.now() / 50) * 10 : 0}deg)`
                            }}
                        >
